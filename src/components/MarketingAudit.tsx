      ...
      <div className="relative z-10">
        ...
        >
          ...
          <div className="mt-6 flex flex-col sm:flex-row justify-center gap-4 text-xs text-slate-500 uppercase tracking-widest font-bold">
            <span className="px-4 py-2 bg-white/5 rounded-xl border border-white/10 backdrop-blur-sm">StoryBrand Framework</span>
            <span className="px-4 py-2 bg-white/5 rounded-xl border border-white/10 backdrop-blur-sm">Direct Response Architecture</span>
          </div>
        </motion.div>
